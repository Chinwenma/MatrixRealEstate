...
const ContactPage: React.FC = () => {
  ...
  return (
    <main>
        <PageBanner title=" Get In Touch" subtitle="Have questions or want to discuss your real estate needs? Reach out to
        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          >
            ...
            <form className="space-y-4 md:space-y-5">
              ...
              <button
                type="submit"
                className="w-full bg-blue-600/80 text-white py-2.5 md:py-3 rounded-lg hover:bg-blue-700 transition font-semibold text-sm md:text-base"
              >
                Send Message
              </button>
            </form>
